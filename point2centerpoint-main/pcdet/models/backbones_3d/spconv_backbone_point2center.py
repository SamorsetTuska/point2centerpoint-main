...
class VoxelResBackBone8xp2c(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv_out = spconv.SparseSequential(
            ...
            norm_fn(out_channel),
            nn.ReLU(),
            # spconv.SubMConv2d(out_channel, out_channel, 3, stride=1, padding=1, bias=False,
            #                   indice_key='conv_out'),
    ...
    def forward(self, batch_dict):
        ...
        x_conv4 = self.conv_out(x_conv4)

        batch_dict.update({
            'spatial_features_2d': x_conv4,
        })
